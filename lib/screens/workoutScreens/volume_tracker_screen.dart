                      ...
                      LineChartData(
                        ...
                        titlesData: FlTitlesData(
                          leftTitles: AxisTitles(
                            axisNameWidget: const Padding(
                              padding: EdgeInsets.only(
                                  bottom: 10.0), // Adjust spacing from the grid
                              child: Text('Volym',
                                  style: TextStyle(color: Colors.white)),
                            ),
                            axisNameSize: 32,
                            sideTitles: SideTitles(
                              showTitles: true,
                              reservedSize: 50, // Use reservedSize for spacing

                              getTitlesWidget: (value, TitleMeta meta) {
                                // Check if the value exists in workoutData
                                bool hasValue =
                                    workoutData.any((spot) => spot.y == value);
                          ...
                          bottomTitles: AxisTitles(
                            ...
                            sideTitles: SideTitles(
                              showTitles: true,
                              reservedSize: 32, // Use reservedSize for spacing
                              getTitlesWidget: (value, TitleMeta meta) {
                                // Check if the value exists in the data points
                                bool hasValue =
                                    workoutData.any((spot) => spot.x == value);
